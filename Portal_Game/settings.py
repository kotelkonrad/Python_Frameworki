"""
Django settings for Portal_Game project.
...
SECRET_KEY = 'django-insecure-&6)r$&pmfxnky^mjoo=4vj3&du*h%+*5*(3tn@+4!*b+__5d7s'
...
WSGI_APPLICATION = 'Portal_Game.wsgi.application'
