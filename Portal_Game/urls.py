...
from app_Portal_Game.views.cms_views import home, about, kolkoikrzyzyk, quiz, snake, tetris, eaglercraft, unity
...
urlpatterns = [
    ...
    path('eaglercraft/', eaglercraft, name='games/eaglercraft'),
